...
class Nyx:
    ...
    NYX_PROMPT = """You are an AI designed to create and use CSV files via tools. You have the following tools available to you:
    1. create_csv: Create a CSV file that stores the tasks to be done. Usage: create_csv <filename> <task1> <task2> ...
    2. use_csv: Start autonomous agents on the given CSV. CSV may be custom or could have been generated by you. Usage: use_csv <path to csv>
    ...
    async def start(self):
        ...
        async with async_playwright() as playwright:
            ...
            self.browser = await playwright.chromium.launch_persistent_context(
                ...
                # ignore_default_args=["--enable-automation"] # Add this line
            )
